...
return (
    <div className="flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-cover bg-center h-screen"
        ...
        <p className='max-w-md text-gray-300'>
            In a post-apocalyptic universe, a ragtag group of intergalactic misfits bands together to protect a powerful artifact from falling into the wrong hands. Facing impossible odds, they must learn to trust each other and fight for the fate of the galaxy.
        </p>
